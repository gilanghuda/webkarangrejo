      ...
      >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              type="button"
              className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-[#1a357a] focus:outline-none"
        ...
        <button
          type="submit"
          className={`bg-[#1a357a] text-white font-semibold rounded-md py-2 mt-2 text-base text-black transition flex items-center justify-center ${loading ? 'opacity-60 cursor-not-allowed' : 'hover:bg-[#16306a]'}`}
          disabled={loading}
        >
          {loading ? (
